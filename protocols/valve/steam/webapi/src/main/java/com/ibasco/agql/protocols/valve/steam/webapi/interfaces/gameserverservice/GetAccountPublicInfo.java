...
public class GetAccountPublicInfo extends SteamGameServerRequest {

    public GetAccountPublicInfo(int apiVersion, long steamId) {
        super("GetAccountPublicInfo", apiVersion);
