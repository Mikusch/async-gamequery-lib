 ...
 */
public class SourcePlayerRequestPacket extends SourceRequestPacket {
    public SourcePlayerRequestPacket() {
    }

    public SourcePlayerRequestPacket(int challenge) {
        setHeader(SourceGameRequest.PLAYER);
