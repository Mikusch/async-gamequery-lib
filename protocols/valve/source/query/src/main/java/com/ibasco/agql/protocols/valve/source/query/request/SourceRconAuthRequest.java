...
import com.ibasco.agql.protocols.valve.source.query.packets.request.SourceRconAuthRequestPacket;
...
public class SourceRconAuthRequest extends SourceRconRequest<SourceRconAuthRequestPacket> {
    ...
    @Override
    public SourceRconAuthRequestPacket getMessage() {
        return new SourceRconAuthRequestPacket(getRequestId(), password);
    }
}
