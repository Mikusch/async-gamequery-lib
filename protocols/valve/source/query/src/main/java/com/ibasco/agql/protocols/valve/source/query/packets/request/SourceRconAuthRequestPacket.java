 ...
 */
public class SourceRconAuthRequestPacket extends SourceRconRequestPacket {
    public SourceRconAuthRequestPacket(int id, String password) {
        super(id);
        setType(SourceRconRequestType.AUTH);
        setBody(password);
    }
}
